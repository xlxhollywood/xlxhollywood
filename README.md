...
| 2024.07.04 | ICT 콤플렉스 SW개발 공모전 [장려상]     | **'인사이트'** : 간단한 심리 테스트를 통해 정신 건강 상태를 점수화하고, 구간별로 상담이 필요한 사람과 정서적 보상이 우선인 사람을 분류해 **맞춤형 지원이 가능하도록 설계된 노숙인 대상 정신건강 관리 서비스** 제안.        | 정보통신산업진흥원       |
