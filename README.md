...
|:----------:|:--------------------------------------:|:---------------------------------------------------------------------------------------------------------------:|:----------------:|
| 2025.02.05 | 현대오토에버<br>배리어프리<br>앱 개발 컨테스트<br> [우수상] | '달리는 어르신' : 보행이 어려운 노인분들을 위한 전동휠체어 공유 서비스.
마치 Z세대가 공유킥보드를 타듯, 거동이 불편한 어르신들도 앱을 통해 근처의 전동휠체어를 손쉽게 대여하고 반납할 수 있도록 하여, 노인의 이동권 보장과 지역 사회의 교통 약자 접근성 향상을 동시에 실현하는 어플리케이션을 제안 |    사단법인 그린라이트    |
| 2024.07.04 |      ICT 콤플렉스 SW개발 공모전 <br>[장려상]       |                                 '인사이트' : 간단한 심리 테스트를 통해 정신 건강 상태를 정량화하고, 점수 구간에 따라 심리 상담이 필요한 대상자와 정서적 보상이 우선인 대상자를 분류하여 맞춤형 지원이 가능하도록 설계된 어플리케이션 제안                                 |    정보통신산업진흥원     |
